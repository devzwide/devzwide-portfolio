    ...
    return (
        <div className="flex flex-col h-[600px] w-full bg-white p-2 pr-16">
            <div className="flex justify-between items-center mb-2">
                <h2 className="text-2xl font-bold text-blue-700">Powered by Gemini</h2>
                <button
                    className="rounded-full bg-blue-100 hover:bg-blue-200 p-2 transition"
                    title="New Chat"
                    onClick={() => setMessages([{ from: "bot", text: "Hello! How can I help you today?" }])}
                >
                    <CiCirclePlus className="w-6 h-6 text-blue-700" />
                </button>
            </div>
