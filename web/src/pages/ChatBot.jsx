...
const ChatBot = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white via-slate-100 to-white flex flex-col">
                    ...
                    <div className="space-y-4 pb-4">
                        ...
                        >
                            ...
                            className={`max-w-[80%] rounded-2xl px-4 py-3 ${
                                message.role === "user"
                                ? "bg-gradient-to-r from-blue-500 to-purple-400 text-white ml-auto"
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            className="bg-gradient-to-r from-blue-500 to-purple-400 hover:from-blue-600 hover:to-purple-500 px-6"
                        >
                            {isLoading ? (
